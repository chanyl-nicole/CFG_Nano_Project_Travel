...
CREATE TABLE `EssentialItems` (
    ...
    `WeatherType` varchar(45) NOT NULL, -- Options: RainyWarm, RainyCold, DryWarm, DryCold
    `ItemNeeded` bit(1) DEFAULT 0 NOT NULL,   -- Item needed yes (1) / no (0)
...
-- Testing the DB =
-- SELECT EssentialItem 
-- FROM CityWeatherByMonth as c 
-- JOIN EssentialItems as e 
-- ON c.WeatherType = e.WeatherType  
-- WHERE `Month` = 'August' AND `DestinationCity` = 'London' AND `ItemNeeded` = 1;
